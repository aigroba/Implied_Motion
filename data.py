...
NSD_PATH = "/home/ana/PycharmProjects/Master/Datasets/NSD"
DATA_PATH = '/home/ana/PycharmProjects/Master/Datasets/NSD/results'
...
def get_study_vcoco(subj):
    ...
    v_img_idx = []
    for i in v_img_list:
        v_img_idx.append(int(i.replace('.png','')))

    v_img = defaultdict(list)
    for idx, val in enumerate(v_img_idx):
        v_img[val].append(idx)
